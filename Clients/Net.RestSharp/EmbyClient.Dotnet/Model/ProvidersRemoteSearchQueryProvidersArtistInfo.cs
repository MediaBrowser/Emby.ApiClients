...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersArtistInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersArtistInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersArtistInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersRemoteSearchQueryProvidersArtistInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersArtistInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersArtistInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersArtistInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersArtistInfo input)
        {
            if (input == null)
                return false;
