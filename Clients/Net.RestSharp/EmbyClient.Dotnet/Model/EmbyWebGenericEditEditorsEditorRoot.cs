...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericEditEditorsEditorRoot :  IEquatable<EmbyWebGenericEditEditorsEditorRoot>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericEditEditorsEditorRoot" /> class.
        /// </summary>
        ...
        public EmbyWebGenericEditEditorsEditorRoot(List<EmbyWebGenericEditConditionsPropertyCondition> propertyConditions = default(List<EmbyWebGenericEditConditionsPropertyCondition>), List<EmbyWebGenericEditActionsPostbackAction> postbackActions = default(List<EmbyWebGenericEditActionsPostbackAction>), EmbyWebGenericEditEditorsEditorButtonItem titleButton = default(EmbyWebGenericEditEditorsEditorButtonItem), List<EmbyWebGenericEditEditorsEditorBase> editorItems = default(List<EmbyWebGenericEditEditorsEditorBase>), EmbyWebGenericEditCommonEditorTypes editorType = default(EmbyWebGenericEditCommonEditorTypes), string name = default(string), string id = default(string), bool? allowEmpty = default(bool?), bool? isReadOnly = default(bool?), bool? isAdvanced = default(bool?), string displayName = default(string), string description = default(string), string parentId = default(string))
        {
        ...
        public List<EmbyWebGenericEditConditionsPropertyCondition> PropertyConditions { get; set; }

        /// <summary>
        /// Gets or Sets PostbackActions
        /// </summary>
        [DataMember(Name="PostbackActions", EmitDefaultValue=false)]
        public List<EmbyWebGenericEditActionsPostbackAction> PostbackActions { get; set; }

        /// <summary>
        /// Gets or Sets TitleButton
        /// </summary>
        [DataMember(Name="TitleButton", EmitDefaultValue=false)]
        public EmbyWebGenericEditEditorsEditorButtonItem TitleButton { get; set; }

        /// <summary>
        /// Gets or Sets EditorItems
        /// </summary>
        [DataMember(Name="EditorItems", EmitDefaultValue=false)]
        public List<EmbyWebGenericEditEditorsEditorBase> EditorItems { get; set; }

        /// <summary>
        /// Gets or Sets EditorType
        /// </summary>
        [DataMember(Name="EditorType", EmitDefaultValue=false)]
        public EmbyWebGenericEditCommonEditorTypes EditorType { get; set; }
        ...
        {
            return this.Equals(input as EmbyWebGenericEditEditorsEditorRoot);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericEditEditorsEditorRoot instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericEditEditorsEditorRoot to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericEditEditorsEditorRoot input)
        {
            if (input == null)
                return false;
