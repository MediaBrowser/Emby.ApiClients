...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersAlbumInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersAlbumInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersAlbumInfo" /> class.
        /// </summary>
        ...
        public ProvidersRemoteSearchQueryProvidersAlbumInfo(ProvidersAlbumInfo searchInfo = default(ProvidersAlbumInfo), long? itemId = default(long?), string searchProviderName = default(string), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ProvidersAlbumInfo SearchInfo { get; set; }
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersAlbumInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersAlbumInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersAlbumInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersAlbumInfo input)
        {
            if (input == null)
                return false;
