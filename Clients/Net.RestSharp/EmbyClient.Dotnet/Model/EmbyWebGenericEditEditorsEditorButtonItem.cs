...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericEditEditorsEditorButtonItem :  IEquatable<EmbyWebGenericEditEditorsEditorButtonItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericEditEditorsEditorButtonItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EmbyWebGenericEditEditorsEditorButtonItem);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericEditEditorsEditorButtonItem instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericEditEditorsEditorButtonItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericEditEditorsEditorButtonItem input)
        {
            if (input == null)
                return false;
