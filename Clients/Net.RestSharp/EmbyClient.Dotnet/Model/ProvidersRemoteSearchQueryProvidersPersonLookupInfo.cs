...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersPersonLookupInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersPersonLookupInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersPersonLookupInfo" /> class.
        /// </summary>
        ...
        public ProvidersRemoteSearchQueryProvidersPersonLookupInfo(ProvidersPersonLookupInfo searchInfo = default(ProvidersPersonLookupInfo), long? itemId = default(long?), string searchProviderName = default(string), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ProvidersPersonLookupInfo SearchInfo { get; set; }
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersPersonLookupInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersPersonLookupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersPersonLookupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersPersonLookupInfo input)
        {
            if (input == null)
                return false;
