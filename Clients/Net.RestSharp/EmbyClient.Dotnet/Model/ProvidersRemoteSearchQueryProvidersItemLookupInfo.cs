...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersItemLookupInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersItemLookupInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersItemLookupInfo" /> class.
        /// </summary>
        ...
        public ProvidersRemoteSearchQueryProvidersItemLookupInfo(ProvidersItemLookupInfo searchInfo = default(ProvidersItemLookupInfo), long? itemId = default(long?), string searchProviderName = default(string), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ProvidersItemLookupInfo SearchInfo { get; set; }
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersItemLookupInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersItemLookupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersItemLookupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersItemLookupInfo input)
        {
            if (input == null)
                return false;
