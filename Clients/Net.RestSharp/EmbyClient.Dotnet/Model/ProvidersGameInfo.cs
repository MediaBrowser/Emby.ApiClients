...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersGameInfo :  IEquatable<ProvidersGameInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersGameInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersGameInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersGameInfo);
        }

        /// <summary>
        /// Returns true if ProvidersGameInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersGameInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersGameInfo input)
        {
            if (input == null)
                return false;
