...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SyncModelSyncDataResponse :  IEquatable<SyncModelSyncDataResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncModelSyncDataResponse" /> class.
        /// </summary>
        /// <param name="itemIdsToRemove">itemIdsToRemove.</param>
        public SyncModelSyncDataResponse(List<string> itemIdsToRemove = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SyncModelSyncDataResponse {\n");
        ...
        {
            return this.Equals(input as SyncModelSyncDataResponse);
        }

        /// <summary>
        /// Returns true if SyncModelSyncDataResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SyncModelSyncDataResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SyncModelSyncDataResponse input)
        {
            if (input == null)
                return false;
