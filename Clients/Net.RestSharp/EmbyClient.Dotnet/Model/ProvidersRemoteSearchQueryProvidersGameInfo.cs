...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersGameInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersGameInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersGameInfo" /> class.
        /// </summary>
        ...
        public ProvidersRemoteSearchQueryProvidersGameInfo(ProvidersGameInfo searchInfo = default(ProvidersGameInfo), long? itemId = default(long?), string searchProviderName = default(string), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ProvidersGameInfo SearchInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersRemoteSearchQueryProvidersGameInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersGameInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersGameInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersGameInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersGameInfo input)
        {
            if (input == null)
                return false;
