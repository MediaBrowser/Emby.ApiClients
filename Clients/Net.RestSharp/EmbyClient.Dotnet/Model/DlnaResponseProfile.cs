...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DlnaResponseProfile :  IEquatable<DlnaResponseProfile>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DlnaResponseProfile" /> class.
        /// </summary>
        ...
        public DlnaResponseProfile(string container = default(string), string audioCodec = default(string), string videoCodec = default(string), DlnaDlnaProfileType type = default(DlnaDlnaProfileType), string orgPn = default(string), string mimeType = default(string), List<DlnaProfileCondition> conditions = default(List<DlnaProfileCondition>))
        {
        ...
        public DlnaDlnaProfileType Type { get; set; }
        ...
        {
            return this.Equals(input as DlnaResponseProfile);
        }

        /// <summary>
        /// Returns true if DlnaResponseProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of DlnaResponseProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlnaResponseProfile input)
        {
            if (input == null)
                return false;
