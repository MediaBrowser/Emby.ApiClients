...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersItemLookupInfo :  IEquatable<ProvidersItemLookupInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersItemLookupInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersItemLookupInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersItemLookupInfo);
        }

        /// <summary>
        /// Returns true if ProvidersItemLookupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersItemLookupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersItemLookupInfo input)
        {
            if (input == null)
                return false;
