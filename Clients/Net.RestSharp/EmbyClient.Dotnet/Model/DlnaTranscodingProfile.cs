...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DlnaTranscodingProfile :  IEquatable<DlnaTranscodingProfile>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DlnaTranscodingProfile" /> class.
        /// </summary>
        ...
        public DlnaTranscodeSeekInfo TranscodeSeekInfo { get; set; }
        ...
        public DlnaEncodingContext Context { get; set; }
        ...
        {
            return this.Equals(input as DlnaTranscodingProfile);
        }

        /// <summary>
        /// Returns true if DlnaTranscodingProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of DlnaTranscodingProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlnaTranscodingProfile input)
        {
            if (input == null)
                return false;
