...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConfigurationTypeOptions :  IEquatable<ConfigurationTypeOptions>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationTypeOptions" /> class.
        /// </summary>
        ...
        public ConfigurationTypeOptions(string type = default(string), List<string> metadataFetchers = default(List<string>), List<string> metadataFetcherOrder = default(List<string>), List<string> imageFetchers = default(List<string>), List<string> imageFetcherOrder = default(List<string>), List<ConfigurationImageOption> imageOptions = default(List<ConfigurationImageOption>))
        {
            this.Type = type;
        ...
        public List<ConfigurationImageOption> ImageOptions { get; set; }
        ...
        {
            return this.Equals(input as ConfigurationTypeOptions);
        }

        /// <summary>
        /// Returns true if ConfigurationTypeOptions instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationTypeOptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationTypeOptions input)
        {
            if (input == null)
                return false;
