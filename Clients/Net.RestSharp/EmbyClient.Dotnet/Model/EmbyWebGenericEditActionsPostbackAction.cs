...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericEditActionsPostbackAction :  IEquatable<EmbyWebGenericEditActionsPostbackAction>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericEditActionsPostbackAction" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EmbyWebGenericEditActionsPostbackAction);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericEditActionsPostbackAction instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericEditActionsPostbackAction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericEditActionsPostbackAction input)
        {
            if (input == null)
                return false;
