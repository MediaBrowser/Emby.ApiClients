...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericEditEditorsEditorBase :  IEquatable<EmbyWebGenericEditEditorsEditorBase>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericEditEditorsEditorBase" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as EmbyWebGenericEditEditorsEditorBase);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericEditEditorsEditorBase instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericEditEditorsEditorBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericEditEditorsEditorBase input)
        {
            if (input == null)
                return false;
