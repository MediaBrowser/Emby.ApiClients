...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SyncModelSyncedItem :  IEquatable<SyncModelSyncedItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncModelSyncedItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SyncModelSyncedItem);
        }

        /// <summary>
        /// Returns true if SyncModelSyncedItem instances are equal
        /// </summary>
        /// <param name="input">Instance of SyncModelSyncedItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SyncModelSyncedItem input)
        {
            if (input == null)
                return false;
