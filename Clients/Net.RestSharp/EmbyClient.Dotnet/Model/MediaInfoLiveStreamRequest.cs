...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MediaInfoLiveStreamRequest :  IEquatable<MediaInfoLiveStreamRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaInfoLiveStreamRequest" /> class.
        /// </summary>
        ...
        public MediaInfoLiveStreamRequest(string openToken = default(string), string userId = default(string), string playSessionId = default(string), long? maxStreamingBitrate = default(long?), long? startTimeTicks = default(long?), int? audioStreamIndex = default(int?), int? subtitleStreamIndex = default(int?), int? maxAudioChannels = default(int?), long? itemId = default(long?), DlnaDeviceProfile deviceProfile = default(DlnaDeviceProfile), bool? enableDirectPlay = default(bool?), bool? enableDirectStream = default(bool?), bool? enableTranscoding = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowInterlacedVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), List<MediaInfoMediaProtocol> directPlayProtocols = default(List<MediaInfoMediaProtocol>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MediaInfoLiveStreamRequest {\n");
        ...
        {
            return this.Equals(input as MediaInfoLiveStreamRequest);
        }

        /// <summary>
        /// Returns true if MediaInfoLiveStreamRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaInfoLiveStreamRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaInfoLiveStreamRequest input)
        {
            if (input == null)
                return false;
