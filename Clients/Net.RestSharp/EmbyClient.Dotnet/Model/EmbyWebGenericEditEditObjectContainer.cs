...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericEditEditObjectContainer :  IEquatable<EmbyWebGenericEditEditObjectContainer>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericEditEditObjectContainer" /> class.
        /// </summary>
        /// <param name="_object">_object.</param>
        /// <param name="defaultObject">defaultObject.</param>
        /// <param name="typeName">typeName.</param>
        /// <param name="editorRoot">editorRoot.</param>
        public EmbyWebGenericEditEditObjectContainer(Object _object = default(Object), Object defaultObject = default(Object), string typeName = default(string), EmbyWebGenericEditEditorsEditorRoot editorRoot = default(EmbyWebGenericEditEditorsEditorRoot))
        {
        ...
        {
            return this.Equals(input as EmbyWebGenericEditEditObjectContainer);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericEditEditObjectContainer instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericEditEditObjectContainer to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericEditEditObjectContainer input)
        {
            if (input == null)
                return false;
