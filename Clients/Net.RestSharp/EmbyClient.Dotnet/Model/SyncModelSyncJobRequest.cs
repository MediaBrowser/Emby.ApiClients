...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SyncModelSyncJobRequest :  IEquatable<SyncModelSyncJobRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncModelSyncJobRequest" /> class.
        /// </summary>
        ...
        public SyncModelSyncJobRequest(string targetId = default(string), List<string> itemIds = default(List<string>), SyncSyncCategory category = default(SyncSyncCategory), string parentId = default(string), string quality = default(string), string profile = default(string), string container = default(string), string videoCodec = default(string), string audioCodec = default(string), string name = default(string), string userId = default(string), bool? unwatchedOnly = default(bool?), bool? syncNewContent = default(bool?), int? itemLimit = default(int?), int? bitrate = default(int?), bool? downloaded = default(bool?))
        {
        ...
        {
            return this.Equals(input as SyncModelSyncJobRequest);
        }

        /// <summary>
        /// Returns true if SyncModelSyncJobRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SyncModelSyncJobRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SyncModelSyncJobRequest input)
        {
            if (input == null)
                return false;
