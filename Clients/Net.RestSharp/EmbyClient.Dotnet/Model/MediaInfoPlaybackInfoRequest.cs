...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MediaInfoPlaybackInfoRequest :  IEquatable<MediaInfoPlaybackInfoRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaInfoPlaybackInfoRequest" /> class.
        /// </summary>
        ...
        public MediaInfoPlaybackInfoRequest(string id = default(string), string userId = default(string), long? maxStreamingBitrate = default(long?), long? startTimeTicks = default(long?), int? audioStreamIndex = default(int?), int? subtitleStreamIndex = default(int?), int? maxAudioChannels = default(int?), string mediaSourceId = default(string), string liveStreamId = default(string), DlnaDeviceProfile deviceProfile = default(DlnaDeviceProfile), bool? enableDirectPlay = default(bool?), bool? enableDirectStream = default(bool?), bool? enableTranscoding = default(bool?), bool? allowInterlacedVideoStreamCopy = default(bool?), bool? allowVideoStreamCopy = default(bool?), bool? allowAudioStreamCopy = default(bool?), bool? isPlayback = default(bool?), bool? autoOpenLiveStream = default(bool?), List<MediaInfoMediaProtocol> directPlayProtocols = default(List<MediaInfoMediaProtocol>), string currentPlaySessionId = default(string))
        {
            this.Id = id;
            this.UserId = userId;
        ...
        public List<MediaInfoMediaProtocol> DirectPlayProtocols { get; set; }
        ...
        {
            return this.Equals(input as MediaInfoPlaybackInfoRequest);
        }

        /// <summary>
        /// Returns true if MediaInfoPlaybackInfoRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaInfoPlaybackInfoRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaInfoPlaybackInfoRequest input)
        {
            if (input == null)
                return false;
