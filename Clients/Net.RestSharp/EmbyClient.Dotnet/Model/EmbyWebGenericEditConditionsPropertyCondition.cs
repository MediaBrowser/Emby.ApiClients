...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyWebGenericEditConditionsPropertyCondition :  IEquatable<EmbyWebGenericEditConditionsPropertyCondition>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyWebGenericEditConditionsPropertyCondition" /> class.
        /// </summary>
        /// <param name="affectedPropertyId">affectedPropertyId.</param>
        /// <param name="conditionType">conditionType.</param>
        /// <param name="targetPropertyId">targetPropertyId.</param>
        /// <param name="simpleCondition">simpleCondition.</param>
        /// <param name="valueCondition">valueCondition.</param>
        /// <param name="value">value.</param>
        public EmbyWebGenericEditConditionsPropertyCondition(string affectedPropertyId = default(string), EmbyWebGenericEditConditionsPropertyConditionType conditionType = default(EmbyWebGenericEditConditionsPropertyConditionType), string targetPropertyId = default(string), AttributesSimpleCondition simpleCondition = default(AttributesSimpleCondition), AttributesValueCondition valueCondition = default(AttributesValueCondition), Object value = default(Object))
        {
        ...
        public EmbyWebGenericEditConditionsPropertyConditionType ConditionType { get; set; }

        /// <summary>
        /// Gets or Sets TargetPropertyId
        /// </summary>
        ...
        {
            return this.Equals(input as EmbyWebGenericEditConditionsPropertyCondition);
        }

        /// <summary>
        /// Returns true if EmbyWebGenericEditConditionsPropertyCondition instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyWebGenericEditConditionsPropertyCondition to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyWebGenericEditConditionsPropertyCondition input)
        {
            if (input == null)
                return false;
