...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersTrailerInfo :  IEquatable<ProvidersTrailerInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersTrailerInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersTrailerInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersTrailerInfo);
        }

        /// <summary>
        /// Returns true if ProvidersTrailerInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersTrailerInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersTrailerInfo input)
        {
            if (input == null)
                return false;
