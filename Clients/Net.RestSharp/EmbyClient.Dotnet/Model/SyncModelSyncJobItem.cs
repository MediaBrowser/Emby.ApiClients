...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SyncModelSyncJobItem :  IEquatable<SyncModelSyncJobItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncModelSyncJobItem" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SyncModelSyncJobItem);
        }

        /// <summary>
        /// Returns true if SyncModelSyncJobItem instances are equal
        /// </summary>
        /// <param name="input">Instance of SyncModelSyncJobItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SyncModelSyncJobItem input)
        {
            if (input == null)
                return false;
