...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DlnaDirectPlayProfile :  IEquatable<DlnaDirectPlayProfile>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DlnaDirectPlayProfile" /> class.
        /// </summary>
        /// <param name="container">container.</param>
        /// <param name="audioCodec">audioCodec.</param>
        /// <param name="videoCodec">videoCodec.</param>
        /// <param name="type">type.</param>
        public DlnaDirectPlayProfile(string container = default(string), string audioCodec = default(string), string videoCodec = default(string), DlnaDlnaProfileType type = default(DlnaDlnaProfileType))
        {
        ...
        {
            return this.Equals(input as DlnaDirectPlayProfile);
        }

        /// <summary>
        /// Returns true if DlnaDirectPlayProfile instances are equal
        /// </summary>
        /// <param name="input">Instance of DlnaDirectPlayProfile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DlnaDirectPlayProfile input)
        {
            if (input == null)
                return false;
