...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities :  IEquatable<MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities);
        }

        /// <summary>
        /// Returns true if MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaEncodingCodecsCommonInterfacesICodecDeviceCapabilities input)
        {
            if (input == null)
                return false;
