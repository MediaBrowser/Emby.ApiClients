...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersTrailerInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersTrailerInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersTrailerInfo" /> class.
        /// </summary>
        ...
        public ProvidersRemoteSearchQueryProvidersTrailerInfo(ProvidersTrailerInfo searchInfo = default(ProvidersTrailerInfo), long? itemId = default(long?), string searchProviderName = default(string), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ProvidersTrailerInfo SearchInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersRemoteSearchQueryProvidersTrailerInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersTrailerInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersTrailerInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersTrailerInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersTrailerInfo input)
        {
            if (input == null)
                return false;
