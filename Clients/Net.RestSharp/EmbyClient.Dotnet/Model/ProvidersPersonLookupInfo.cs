...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersPersonLookupInfo :  IEquatable<ProvidersPersonLookupInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersPersonLookupInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersPersonLookupInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersPersonLookupInfo);
        }

        /// <summary>
        /// Returns true if ProvidersPersonLookupInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersPersonLookupInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersPersonLookupInfo input)
        {
            if (input == null)
                return false;
