...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersArtistInfo :  IEquatable<ProvidersArtistInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersArtistInfo" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProvidersArtistInfo);
        }

        /// <summary>
        /// Returns true if ProvidersArtistInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersArtistInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersArtistInfo input)
        {
            if (input == null)
                return false;
