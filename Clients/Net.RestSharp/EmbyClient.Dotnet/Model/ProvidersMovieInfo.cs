...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersMovieInfo :  IEquatable<ProvidersMovieInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersMovieInfo" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ProvidersMovieInfo);
        }

        /// <summary>
        /// Returns true if ProvidersMovieInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersMovieInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersMovieInfo input)
        {
            if (input == null)
                return false;
