...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SyncModelSyncProfileOption :  IEquatable<SyncModelSyncProfileOption>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SyncModelSyncProfileOption" /> class.
        /// </summary>
        ...
        public SyncModelSyncProfileOption(string name = default(string), string description = default(string), string id = default(string), bool? isDefault = default(bool?), bool? enableQualityOptions = default(bool?))
        {
            this.Name = name;
        ...
        {
            return this.Equals(input as SyncModelSyncProfileOption);
        }

        /// <summary>
        /// Returns true if SyncModelSyncProfileOption instances are equal
        /// </summary>
        /// <param name="input">Instance of SyncModelSyncProfileOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SyncModelSyncProfileOption input)
        {
            if (input == null)
                return false;
