...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EmbyDlnaProfilesDeviceIdentification :  IEquatable<EmbyDlnaProfilesDeviceIdentification>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbyDlnaProfilesDeviceIdentification" /> class.
        /// </summary>
        ...
        public List<EmbyDlnaProfilesHttpHeaderInfo> Headers { get; set; }
        ...
        {
            return this.Equals(input as EmbyDlnaProfilesDeviceIdentification);
        }

        /// <summary>
        /// Returns true if EmbyDlnaProfilesDeviceIdentification instances are equal
        /// </summary>
        /// <param name="input">Instance of EmbyDlnaProfilesDeviceIdentification to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmbyDlnaProfilesDeviceIdentification input)
        {
            if (input == null)
                return false;
