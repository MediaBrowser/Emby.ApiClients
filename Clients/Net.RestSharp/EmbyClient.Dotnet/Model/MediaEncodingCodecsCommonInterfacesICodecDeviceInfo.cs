...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MediaEncodingCodecsCommonInterfacesICodecDeviceInfo :  IEquatable<MediaEncodingCodecsCommonInterfacesICodecDeviceInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaEncodingCodecsCommonInterfacesICodecDeviceInfo" /> class.
        /// </summary>
        ...
        public EmbyMediaModelEnumsSecondaryFrameworks HardwareContextFramework { get; set; }
        ...
        {
            return this.Equals(input as MediaEncodingCodecsCommonInterfacesICodecDeviceInfo);
        }

        /// <summary>
        /// Returns true if MediaEncodingCodecsCommonInterfacesICodecDeviceInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaEncodingCodecsCommonInterfacesICodecDeviceInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaEncodingCodecsCommonInterfacesICodecDeviceInfo input)
        {
            if (input == null)
                return false;
