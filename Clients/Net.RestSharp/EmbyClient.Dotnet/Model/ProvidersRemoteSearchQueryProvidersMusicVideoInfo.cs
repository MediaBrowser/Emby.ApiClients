...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersMusicVideoInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersMusicVideoInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersMusicVideoInfo" /> class.
        /// </summary>
        ...
        public ProvidersRemoteSearchQueryProvidersMusicVideoInfo(ProvidersMusicVideoInfo searchInfo = default(ProvidersMusicVideoInfo), long? itemId = default(long?), string searchProviderName = default(string), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ProvidersMusicVideoInfo SearchInfo { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersRemoteSearchQueryProvidersMusicVideoInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersMusicVideoInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersMusicVideoInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersMusicVideoInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersMusicVideoInfo input)
        {
            if (input == null)
                return false;
