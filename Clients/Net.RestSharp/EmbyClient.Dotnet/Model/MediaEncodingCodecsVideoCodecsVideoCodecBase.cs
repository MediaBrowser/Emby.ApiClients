...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MediaEncodingCodecsVideoCodecsVideoCodecBase :  IEquatable<MediaEncodingCodecsVideoCodecsVideoCodecBase>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaEncodingCodecsVideoCodecsVideoCodecBase" /> class.
        /// </summary>
        ...
        public MediaEncodingCodecsVideoCodecsVideoCodecBase(MediaEncodingCodecsCommonInterfacesICodecDeviceInfo codecDeviceInfo = default(MediaEncodingCodecsCommonInterfacesICodecDeviceInfo), EmbyMediaModelEnumsCodecKinds codecKind = default(EmbyMediaModelEnumsCodecKinds), string mediaTypeName = default(string), EmbyMediaModelEnumsVideoMediaTypes videoMediaType = default(EmbyMediaModelEnumsVideoMediaTypes), int? minWidth = default(int?), int? maxWidth = default(int?), int? minHeight = default(int?), int? maxHeight = default(int?), int? widthAlignment = default(int?), int? heightAlignment = default(int?), EmbyMediaModelTypesBitRate maxBitRate = default(EmbyMediaModelTypesBitRate), List<EmbyMediaModelEnumsColorFormats> supportedColorFormats = default(List<EmbyMediaModelEnumsColorFormats>), List<string> supportedColorFormatStrings = default(List<string>), List<EmbyMediaModelTypesProfileLevelInformation> profileAndLevelInformation = default(List<EmbyMediaModelTypesProfileLevelInformation>), string id = default(string), EmbyMediaModelEnumsCodecDirections direction = default(EmbyMediaModelEnumsCodecDirections), string name = default(string), string description = default(string), string frameworkCodec = default(string), bool? isHardwareCodec = default(bool?), EmbyMediaModelEnumsSecondaryFrameworks secondaryFramework = default(EmbyMediaModelEnumsSecondaryFrameworks), string secondaryFrameworkCodec = default(string), int? maxInstanceCount = default(int?), bool? isEnabledByDefault = default(bool?), int? defaultPriority = default(int?))
        {
        ...
        public EmbyMediaModelEnumsCodecKinds CodecKind { get; set; }
        ...
        public EmbyMediaModelEnumsVideoMediaTypes VideoMediaType { get; set; }
        ...
        public List<EmbyMediaModelEnumsColorFormats> SupportedColorFormats { get; set; }
        ...
        public List<EmbyMediaModelTypesProfileLevelInformation> ProfileAndLevelInformation { get; set; }
        ...
        public EmbyMediaModelEnumsCodecDirections Direction { get; set; }
        ...
        public EmbyMediaModelEnumsSecondaryFrameworks SecondaryFramework { get; set; }
        ...
        {
            return this.Equals(input as MediaEncodingCodecsVideoCodecsVideoCodecBase);
        }

        /// <summary>
        /// Returns true if MediaEncodingCodecsVideoCodecsVideoCodecBase instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaEncodingCodecsVideoCodecsVideoCodecBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaEncodingCodecsVideoCodecsVideoCodecBase input)
        {
            if (input == null)
                return false;
