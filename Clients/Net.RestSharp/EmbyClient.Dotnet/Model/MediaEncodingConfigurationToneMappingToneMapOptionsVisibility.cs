...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MediaEncodingConfigurationToneMappingToneMapOptionsVisibility :  IEquatable<MediaEncodingConfigurationToneMappingToneMapOptionsVisibility>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MediaEncodingConfigurationToneMappingToneMapOptionsVisibility" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MediaEncodingConfigurationToneMappingToneMapOptionsVisibility {\n");
        ...
        {
            return this.Equals(input as MediaEncodingConfigurationToneMappingToneMapOptionsVisibility);
        }

        /// <summary>
        /// Returns true if MediaEncodingConfigurationToneMappingToneMapOptionsVisibility instances are equal
        /// </summary>
        /// <param name="input">Instance of MediaEncodingConfigurationToneMappingToneMapOptionsVisibility to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MediaEncodingConfigurationToneMappingToneMapOptionsVisibility input)
        {
            if (input == null)
                return false;
