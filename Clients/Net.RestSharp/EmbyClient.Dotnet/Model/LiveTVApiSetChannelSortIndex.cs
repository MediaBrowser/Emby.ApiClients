...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LiveTVApiSetChannelSortIndex :  IEquatable<LiveTVApiSetChannelSortIndex>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LiveTVApiSetChannelSortIndex" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="managementId">managementId.</param>
        /// <param name="newIndex">newIndex.</param>
        public LiveTVApiSetChannelSortIndex(string id = default(string), string managementId = default(string), int? newIndex = default(int?))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as LiveTVApiSetChannelSortIndex);
        }

        /// <summary>
        /// Returns true if LiveTVApiSetChannelSortIndex instances are equal
        /// </summary>
        /// <param name="input">Instance of LiveTVApiSetChannelSortIndex to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LiveTVApiSetChannelSortIndex input)
        {
            if (input == null)
                return false;
