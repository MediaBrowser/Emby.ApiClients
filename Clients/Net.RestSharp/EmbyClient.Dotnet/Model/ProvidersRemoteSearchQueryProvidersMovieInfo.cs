...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersMovieInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersMovieInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersMovieInfo" /> class.
        /// </summary>
        ...
        public ProvidersRemoteSearchQueryProvidersMovieInfo(ProvidersMovieInfo searchInfo = default(ProvidersMovieInfo), long? itemId = default(long?), string searchProviderName = default(string), bool? includeDisabledProviders = default(bool?))
        {
        ...
        public ProvidersMovieInfo SearchInfo { get; set; }
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersMovieInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersMovieInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersMovieInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersMovieInfo input)
        {
            if (input == null)
                return false;
