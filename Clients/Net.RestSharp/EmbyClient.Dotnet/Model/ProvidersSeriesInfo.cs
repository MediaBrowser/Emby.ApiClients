...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersSeriesInfo :  IEquatable<ProvidersSeriesInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersSeriesInfo" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets EpisodeAirDate
        /// </summary>
        [DataMember(Name="EpisodeAirDate", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as ProvidersSeriesInfo);
        }

        /// <summary>
        /// Returns true if ProvidersSeriesInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersSeriesInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersSeriesInfo input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.EpisodeAirDate == input.EpisodeAirDate ||
