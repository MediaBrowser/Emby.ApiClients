...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UsersUserPolicy :  IEquatable<UsersUserPolicy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersUserPolicy" /> class.
        /// </summary>
        ...
        /// <param name="enableSyncTranscoding">enableSyncTranscoding.</param>
        ...
        /// <summary>
        /// Gets or Sets MaxParentalRating
        /// </summary>
        ...
        public List<ConfigurationAccessSchedule> AccessSchedules { get; set; }

        /// <summary>
        /// Gets or Sets BlockUnratedItems
        /// </summary>
        [DataMember(Name="BlockUnratedItems", EmitDefaultValue=false)]
        public List<ConfigurationUnratedItem> BlockUnratedItems { get; set; }
        ...
        /// <summary>
        /// Gets or Sets EnableSyncTranscoding
        /// </summary>
        ...
        {
            return this.Equals(input as UsersUserPolicy);
        }

        /// <summary>
        /// Returns true if UsersUserPolicy instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersUserPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersUserPolicy input)
        {
            if (input == null)
                return false;
