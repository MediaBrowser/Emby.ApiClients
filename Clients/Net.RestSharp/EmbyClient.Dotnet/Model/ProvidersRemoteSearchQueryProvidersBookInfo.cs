...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersRemoteSearchQueryProvidersBookInfo :  IEquatable<ProvidersRemoteSearchQueryProvidersBookInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersRemoteSearchQueryProvidersBookInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersRemoteSearchQueryProvidersBookInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersRemoteSearchQueryProvidersBookInfo);
        }

        /// <summary>
        /// Returns true if ProvidersRemoteSearchQueryProvidersBookInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersRemoteSearchQueryProvidersBookInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersRemoteSearchQueryProvidersBookInfo input)
        {
            if (input == null)
                return false;
