...
namespace EmbyClient.Dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProvidersMusicVideoInfo :  IEquatable<ProvidersMusicVideoInfo>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersMusicVideoInfo" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProvidersMusicVideoInfo {\n");
        ...
        {
            return this.Equals(input as ProvidersMusicVideoInfo);
        }

        /// <summary>
        /// Returns true if ProvidersMusicVideoInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of ProvidersMusicVideoInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersMusicVideoInfo input)
        {
            if (input == null)
                return false;
