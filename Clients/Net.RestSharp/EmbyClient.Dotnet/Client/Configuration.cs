...
namespace EmbyClient.Dotnet.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "4.10.0.40";
        ...
        public Configuration(
            ...
            string basePath = "http://emby.media/emby") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "/4.10.0.40/dotnet"
        ...
        {
            String report = "C# SDK (EmbyClient.Dotnet) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 4.10.0.40\n";
            report += "    SDK Package Version: 4.10.0.40\n";
