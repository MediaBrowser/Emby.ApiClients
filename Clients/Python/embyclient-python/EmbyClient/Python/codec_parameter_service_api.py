...
class CodecParameterServiceApi(object):
    ...
    def get_encodingdiagnostics_codecparameters(self, codec_id, parameter_context, **kwargs):  # noqa: E501
        """Gets the parameters for a specified codec.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_encodingdiagnostics_codecparameters(codec_id, parameter_context, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_encodingdiagnostics_codecparameters_with_http_info(codec_id, parameter_context, **kwargs)  # noqa: E501
        else:
            (data) = self.get_encodingdiagnostics_codecparameters_with_http_info(codec_id, parameter_context, **kwargs)  # noqa: E501
            return data

    def get_encodingdiagnostics_codecparameters_with_http_info(self, codec_id, parameter_context, **kwargs):  # noqa: E501
        """Gets the parameters for a specified codec.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_encodingdiagnostics_codecparameters_with_http_info(codec_id, parameter_context, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_encodingdiagnostics_codecparameters" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'codec_id' is set
        if ('codec_id' not in params or
                params['codec_id'] is None):
            raise ValueError("Missing the required parameter `codec_id` when calling `get_encodingdiagnostics_codecparameters`")  # noqa: E501
        # verify the required parameter 'parameter_context' is set
        if ('parameter_context' not in params or
                params['parameter_context'] is None):
            raise ValueError("Missing the required parameter `parameter_context` when calling `get_encodingdiagnostics_codecparameters`")  # noqa: E501
    ...
    def post_encodingdiagnostics_codecparameters(self, body, codec_id, parameter_context, **kwargs):  # noqa: E501
        """Updates the parameters for a specified codec.  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_encodingdiagnostics_codecparameters(body, codec_id, parameter_context, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_encodingdiagnostics_codecparameters_with_http_info(body, codec_id, parameter_context, **kwargs)  # noqa: E501
        else:
            (data) = self.post_encodingdiagnostics_codecparameters_with_http_info(body, codec_id, parameter_context, **kwargs)  # noqa: E501
            return data

    def post_encodingdiagnostics_codecparameters_with_http_info(self, body, codec_id, parameter_context, **kwargs):  # noqa: E501
        """Updates the parameters for a specified codec.  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_encodingdiagnostics_codecparameters_with_http_info(body, codec_id, parameter_context, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_encodingdiagnostics_codecparameters" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_encodingdiagnostics_codecparameters`")  # noqa: E501
        # verify the required parameter 'codec_id' is set
        if ('codec_id' not in params or
                params['codec_id'] is None):
            raise ValueError("Missing the required parameter `codec_id` when calling `post_encodingdiagnostics_codecparameters`")  # noqa: E501
        # verify the required parameter 'parameter_context' is set
        if ('parameter_context' not in params or
                params['parameter_context'] is None):
            raise ValueError("Missing the required parameter `parameter_context` when calling `post_encodingdiagnostics_codecparameters`")  # noqa: E501
