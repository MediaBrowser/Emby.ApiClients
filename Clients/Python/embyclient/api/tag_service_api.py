...
class TagServiceApi(object):
    ...
    def get_audiolayouts(self, **kwargs):  # noqa: E501
        """Gets items based on a query.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audiolayouts(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_audiolayouts_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_audiolayouts_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_audiolayouts_with_http_info(self, **kwargs):  # noqa: E501
        """Gets items based on a query.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audiolayouts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_audiolayouts" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_extendedvideotypes(self, **kwargs):  # noqa: E501
        """Gets items based on a query.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_extendedvideotypes(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_extendedvideotypes_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_extendedvideotypes_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_extendedvideotypes_with_http_info(self, **kwargs):  # noqa: E501
        """Gets items based on a query.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_extendedvideotypes_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_extendedvideotypes" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def post_items_by_id_tags_delete(self, body, id, **kwargs):  # noqa: E501
        """Removes tags from an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_id_tags_delete(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserLibraryRemoveTags body: RemoveTags (required)
        :param str id: Item Id (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_items_by_id_tags_delete_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_items_by_id_tags_delete_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def post_items_by_id_tags_delete_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Removes tags from an item  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_items_by_id_tags_delete_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_items_by_id_tags_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_items_by_id_tags_delete`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `post_items_by_id_tags_delete`")  # noqa: E501
