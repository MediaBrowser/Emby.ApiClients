...
class UserLibraryServiceApi(object):
    ...
    def post_users_by_userid_searcheditems(self, body, user_id, **kwargs):  # noqa: E501
        """Marks an item as a favorite  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_userid_searcheditems(body, user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param UserLibraryReportItemsSearched body: ReportItemsSearched (required)
        :param str user_id: User Id (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_users_by_userid_searcheditems_with_http_info(body, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_users_by_userid_searcheditems_with_http_info(body, user_id, **kwargs)  # noqa: E501
            return data

    def post_users_by_userid_searcheditems_with_http_info(self, body, user_id, **kwargs):  # noqa: E501
        """Marks an item as a favorite  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_userid_searcheditems_with_http_info(body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_users_by_userid_searcheditems" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_users_by_userid_searcheditems`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `post_users_by_userid_searcheditems`")  # noqa: E501
