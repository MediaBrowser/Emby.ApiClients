...
class SubtitleServiceApi(object):
    ...
    def get_videos_by_id_by_mediasourceid_attachments_by_index_stream(self, id, media_source_id, index, **kwargs):  # noqa: E501
        """Gets subtitles in a specified format.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_videos_by_id_by_mediasourceid_attachments_by_index_stream(id, media_source_id, index, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_videos_by_id_by_mediasourceid_attachments_by_index_stream_with_http_info(id, media_source_id, index, **kwargs)  # noqa: E501
        else:
            (data) = self.get_videos_by_id_by_mediasourceid_attachments_by_index_stream_with_http_info(id, media_source_id, index, **kwargs)  # noqa: E501
            return data

    def get_videos_by_id_by_mediasourceid_attachments_by_index_stream_with_http_info(self, id, media_source_id, index, **kwargs):  # noqa: E501
        """Gets subtitles in a specified format.  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_videos_by_id_by_mediasourceid_attachments_by_index_stream_with_http_info(id, media_source_id, index, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_videos_by_id_by_mediasourceid_attachments_by_index_stream" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_videos_by_id_by_mediasourceid_attachments_by_index_stream`")  # noqa: E501
        # verify the required parameter 'media_source_id' is set
        if ('media_source_id' not in params or
                params['media_source_id'] is None):
            raise ValueError("Missing the required parameter `media_source_id` when calling `get_videos_by_id_by_mediasourceid_attachments_by_index_stream`")  # noqa: E501
        # verify the required parameter 'index' is set
        if ('index' not in params or
                params['index'] is None):
            raise ValueError("Missing the required parameter `index` when calling `get_videos_by_id_by_mediasourceid_attachments_by_index_stream`")  # noqa: E501
