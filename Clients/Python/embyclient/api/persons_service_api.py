...
class PersonsServiceApi(object):
    ...
    def get_persons_by_id_credits(self, id, **kwargs):  # noqa: E501
        """Gets credits for a person  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_persons_by_id_credits(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: The person id (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_persons_by_id_credits_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_persons_by_id_credits_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_persons_by_id_credits_with_http_info(self, id, **kwargs):  # noqa: E501
        """Gets credits for a person  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_persons_by_id_credits_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_persons_by_id_credits" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_persons_by_id_credits`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[UserLibraryCreditsList]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
