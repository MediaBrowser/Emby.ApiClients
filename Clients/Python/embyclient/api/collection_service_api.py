...
class CollectionServiceApi(object):
    ...
    def get_collections_by_id_missing(self, id, **kwargs):  # noqa: E501
        """Gets a list of missing items  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collections_by_id_missing(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_collections_by_id_missing_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_collections_by_id_missing_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_collections_by_id_missing_with_http_info(self, id, **kwargs):  # noqa: E501
        """Gets a list of missing items  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collections_by_id_missing_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_collections_by_id_missing" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_collections_by_id_missing`")  # noqa: E501
    ...
    def get_collections_by_id_provideritems(self, id, **kwargs):  # noqa: E501
        """Gets a list of missing items  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collections_by_id_provideritems(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_collections_by_id_provideritems_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_collections_by_id_provideritems_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_collections_by_id_provideritems_with_http_info(self, id, **kwargs):  # noqa: E501
        """Gets a list of missing items  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collections_by_id_provideritems_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_collections_by_id_provideritems" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_collections_by_id_provideritems`")  # noqa: E501
