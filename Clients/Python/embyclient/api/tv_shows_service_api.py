...
class TvShowsServiceApi(object):
    ...
    def get_shows_by_id_seasons(self, id, **kwargs):  # noqa: E501
        """Gets seasons for a tv series  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_shows_by_id_seasons(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_shows_by_id_seasons_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_shows_by_id_seasons_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_shows_by_id_seasons_with_http_info(self, id, **kwargs):  # noqa: E501
        """Gets seasons for a tv series  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_shows_by_id_seasons_with_http_info(id, async_req=True)
        >>> result = thread.get()
