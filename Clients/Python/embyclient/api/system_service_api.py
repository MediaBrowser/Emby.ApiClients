...
class SystemServiceApi(object):
    ...
    def head_system_ping(self, **kwargs):  # noqa: E501
        """head_system_ping  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.head_system_ping(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.head_system_ping_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.head_system_ping_with_http_info(**kwargs)  # noqa: E501
            return data

    def head_system_ping_with_http_info(self, **kwargs):  # noqa: E501
        """head_system_ping  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.head_system_ping_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method head_system_ping" % key
                )
            params[key] = val
        del params['kwargs']
