...
class UserServiceApi(object):
    ...
    def delete_users_by_id_recentlysearched(self, id, **kwargs):  # noqa: E501
        """Clears recently searched  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_users_by_id_recentlysearched(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_users_by_id_recentlysearched_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_users_by_id_recentlysearched_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def delete_users_by_id_recentlysearched_with_http_info(self, id, **kwargs):  # noqa: E501
        """Clears recently searched  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_users_by_id_recentlysearched_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_users_by_id_recentlysearched" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `delete_users_by_id_recentlysearched`")  # noqa: E501
    ...
    def get_users_copydataoptions(self, **kwargs):  # noqa: E501
        """Gets copy data options  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_users_copydataoptions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_users_copydataoptions_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_users_copydataoptions_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_users_copydataoptions_with_http_info(self, **kwargs):  # noqa: E501
        """Gets copy data options  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_users_copydataoptions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_users_copydataoptions" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='LibraryFullUserCopyDataOptions',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def post_users_by_id_recentlysearched_delete(self, id, **kwargs):  # noqa: E501
        """Clears recently searched  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_id_recentlysearched_delete(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_users_by_id_recentlysearched_delete_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_users_by_id_recentlysearched_delete_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def post_users_by_id_recentlysearched_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        """Clears recently searched  # noqa: E501

        Requires authentication as user  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_id_recentlysearched_delete_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_users_by_id_recentlysearched_delete" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `post_users_by_id_recentlysearched_delete`")  # noqa: E501
    ...
    def post_users_by_userid_copydata(self, body, user_id, **kwargs):  # noqa: E501
        """Copies data from one user to another  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_userid_copydata(body, user_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CopyData body: CopyData (required)
        :param str user_id: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.post_users_by_userid_copydata_with_http_info(body, user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.post_users_by_userid_copydata_with_http_info(body, user_id, **kwargs)  # noqa: E501
            return data

    def post_users_by_userid_copydata_with_http_info(self, body, user_id, **kwargs):  # noqa: E501
        """Copies data from one user to another  # noqa: E501

        Requires authentication as administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_users_by_userid_copydata_with_http_info(body, user_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_users_by_userid_copydata" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `post_users_by_userid_copydata`")  # noqa: E501
        # verify the required parameter 'user_id' is set
        if ('user_id' not in params or
                params['user_id'] is None):
            raise ValueError("Missing the required parameter `user_id` when calling `post_users_by_userid_copydata`")  # noqa: E501
