...
/**
* The ProvidersPersonLookupInfo model module.
* @module model/ProvidersPersonLookupInfo
* @version 0.0.0.0
*/
export default class ProvidersPersonLookupInfo {
    /**
    * Constructs a new <code>ProvidersPersonLookupInfo</code>.
    * @alias module:model/ProvidersPersonLookupInfo
    * @class
    */
    ...
    /**
    * Constructs a <code>ProvidersPersonLookupInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProvidersPersonLookupInfo} obj Optional instance to populate.
    * @return {module:model/ProvidersPersonLookupInfo} The populated <code>ProvidersPersonLookupInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvidersPersonLookupInfo();
