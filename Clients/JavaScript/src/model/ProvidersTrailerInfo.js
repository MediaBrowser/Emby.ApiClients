...
/**
* The ProvidersTrailerInfo model module.
* @module model/ProvidersTrailerInfo
* @version 0.0.0.0
*/
export default class ProvidersTrailerInfo {
    /**
    * Constructs a new <code>ProvidersTrailerInfo</code>.
    * @alias module:model/ProvidersTrailerInfo
    * @class
    */
    ...
    /**
    * Constructs a <code>ProvidersTrailerInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProvidersTrailerInfo} obj Optional instance to populate.
    * @return {module:model/ProvidersTrailerInfo} The populated <code>ProvidersTrailerInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvidersTrailerInfo();
