...
/**
* The ProvidersItemLookupInfo model module.
* @module model/ProvidersItemLookupInfo
* @version 0.0.0.0
*/
export default class ProvidersItemLookupInfo {
    /**
    * Constructs a new <code>ProvidersItemLookupInfo</code>.
    * @alias module:model/ProvidersItemLookupInfo
    * @class
    */
    ...
    /**
    * Constructs a <code>ProvidersItemLookupInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProvidersItemLookupInfo} obj Optional instance to populate.
    * @return {module:model/ProvidersItemLookupInfo} The populated <code>ProvidersItemLookupInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvidersItemLookupInfo();
