...
/**
* The ProvidersSongInfo model module.
* @module model/ProvidersSongInfo
* @version 0.0.0.0
*/
export default class ProvidersSongInfo {
    /**
    * Constructs a new <code>ProvidersSongInfo</code>.
    * @alias module:model/ProvidersSongInfo
    * @class
    */
    ...
    /**
    * Constructs a <code>ProvidersSongInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProvidersSongInfo} obj Optional instance to populate.
    * @return {module:model/ProvidersSongInfo} The populated <code>ProvidersSongInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvidersSongInfo();
