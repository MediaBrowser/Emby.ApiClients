...
export default class ProvidersArtistInfo {
    /**
    * Constructs a new <code>ProvidersArtistInfo</code>.
    * @alias module:model/ProvidersArtistInfo
    * @class
    */
    ...
    /**
    * Constructs a <code>ProvidersArtistInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ProvidersArtistInfo} obj Optional instance to populate.
    * @return {module:model/ProvidersArtistInfo} The populated <code>ProvidersArtistInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProvidersArtistInfo();
