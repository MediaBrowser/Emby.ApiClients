...
import ConfigurationUnratedItem from './ConfigurationUnratedItem';
...
export default class UsersUserPolicy {
    /**
    * Constructs a new <code>UsersUserPolicy</code>.
    * @alias module:model/UsersUserPolicy
    * @class
    */
    ...
    /**
    * Constructs a <code>UsersUserPolicy</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/UsersUserPolicy} obj Optional instance to populate.
    * @return {module:model/UsersUserPolicy} The populated <code>UsersUserPolicy</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UsersUserPolicy();
            ...
            if (data.hasOwnProperty('AccessSchedules')) {
                obj['AccessSchedules'] = ApiClient.convertToType(data['AccessSchedules'], [ConfigurationAccessSchedule]);
            }
            if (data.hasOwnProperty('BlockUnratedItems')) {
                obj['BlockUnratedItems'] = ApiClient.convertToType(data['BlockUnratedItems'], [ConfigurationUnratedItem]);
            }
    ...
    */
    ...
    /**
    * @member {Array.<module:model/ConfigurationAccessSchedule>} AccessSchedules
    */
    'AccessSchedules' = undefined;
    /**
    * @member {Array.<module:model/ConfigurationUnratedItem>} BlockUnratedItems
    */
