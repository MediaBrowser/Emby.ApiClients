...
export default class ItemLookupInfo {
    /**
    * Constructs a new <code>ItemLookupInfo</code>.
    * @alias module:model/ItemLookupInfo
    * @class
    */
    ...
    /**
    * Constructs a <code>ItemLookupInfo</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ItemLookupInfo} obj Optional instance to populate.
    * @return {module:model/ItemLookupInfo} The populated <code>ItemLookupInfo</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ItemLookupInfo();
