...
export default class ConfigurationLibraryOptions {
    /**
    * Constructs a new <code>ConfigurationLibraryOptions</code>.
    * @alias module:model/ConfigurationLibraryOptions
    * @class
    */
    ...
    /**
    * Constructs a <code>ConfigurationLibraryOptions</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/ConfigurationLibraryOptions} obj Optional instance to populate.
    * @return {module:model/ConfigurationLibraryOptions} The populated <code>ConfigurationLibraryOptions</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigurationLibraryOptions();
            ...
            if (data.hasOwnProperty('PathInfos')) {
                obj['PathInfos'] = ApiClient.convertToType(data['PathInfos'], [ConfigurationMediaPathInfo]);
            }
    ...
    */
    ...
    /**
    * @member {Array.<module:model/ConfigurationMediaPathInfo>} PathInfos
    */
    'PathInfos' = undefined;
    /**
