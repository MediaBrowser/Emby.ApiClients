...
export default class MediaEncodingConfigurationToneMappingToneMapOptionsVisibility {
    /**
    * Constructs a new <code>MediaEncodingConfigurationToneMappingToneMapOptionsVisibility</code>.
    * @alias module:model/MediaEncodingConfigurationToneMappingToneMapOptionsVisibility
    * @class
    */
    ...
    /**
    * Constructs a <code>MediaEncodingConfigurationToneMappingToneMapOptionsVisibility</code> from a plain JavaScript object, optionally creating a new instance.
    * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
    * @param {Object} data The plain JavaScript object bearing properties of interest.
    * @param {module:model/MediaEncodingConfigurationToneMappingToneMapOptionsVisibility} obj Optional instance to populate.
    * @return {module:model/MediaEncodingConfigurationToneMappingToneMapOptionsVisibility} The populated <code>MediaEncodingConfigurationToneMappingToneMapOptionsVisibility</code> instance.
    */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MediaEncodingConfigurationToneMappingToneMapOptionsVisibility();
