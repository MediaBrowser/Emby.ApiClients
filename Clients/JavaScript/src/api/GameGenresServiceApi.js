...
export default class GameGenresServiceApi {
    ...
    * @alias module:api/GameGenresServiceApi
    * @class
    ...
    */
     ...
     */
    getGamegenres() {
      return this.getGamegenresWithHttpInfo()
     ...
     */
    getGamegenresByNameWithHttpInfo() {
      opts = opts || {};
      let postBody = null;
     ...
     */
    getGamegenresByName() {
      return this.getGamegenresByNameWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
