...
export default class StudiosServiceApi {
    ...
    * @alias module:api/StudiosServiceApi
    * @class
    ...
    */
     ...
     */
    getStudios() {
      return this.getStudiosWithHttpInfo()
     ...
     */
    getStudiosByName() {
      return this.getStudiosByNameWithHttpInfo()
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
