...
export default class GenresServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript/GenresServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript/GenresServiceApi~getGenresCallback
     ...
     * @param {module:EmbyClient.JavaScript/GenresServiceApi~getGenresCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript/GenresServiceApi~getGenresByNameCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript/GenresServiceApi~getGenresByNameCallback} callback The callback function, accepting three arguments: error, data, response
