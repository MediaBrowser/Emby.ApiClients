...
export default class CodecParameterServiceApi {
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript/CodecParameterServiceApi~getEncodingdiagnosticsCodecparametersCallback
     * @param {String} error Error message, if any.
     * @param {module:model/EmbyWebGenericEditEditObjectContainer} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Gets the parameters for a specified codec.
     * Requires authentication as user
     * @param {module:EmbyClient.JavaScript/CodecParameterServiceApi~getEncodingdiagnosticsCodecparametersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/EmbyWebGenericEditEditObjectContainer}
     */
     ...
     * @callback module:EmbyClient.JavaScript/CodecParameterServiceApi~postEncodingdiagnosticsCodecparametersCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * Updates the parameters for a specified codec.
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript/CodecParameterServiceApi~postEncodingdiagnosticsCodecparametersCallback} callback The callback function, accepting three arguments: error, data, response
     */
