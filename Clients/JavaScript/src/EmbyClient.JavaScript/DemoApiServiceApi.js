...
* @module EmbyClient.JavaScript/DemoApiServiceApi
* @version 0.0.0.0
*/
export default class DemoApiServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript/DemoApiServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript/DemoApiServiceApi~getGenericeditdemoDemoCallback
     ...
     * @param {module:EmbyClient.JavaScript/DemoApiServiceApi~getGenericeditdemoDemoCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript/DemoApiServiceApi~getGenericeditdemoDemotypesCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript/DemoApiServiceApi~getGenericeditdemoDemotypesCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript/DemoApiServiceApi~postGenericeditdemoDemoCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as administrator
     * @param {module:EmbyClient.JavaScript/DemoApiServiceApi~postGenericeditdemoDemoCallback} callback The callback function, accepting three arguments: error, data, response
     */
