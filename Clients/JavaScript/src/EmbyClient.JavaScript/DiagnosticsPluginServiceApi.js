...
* @module EmbyClient.JavaScript/DiagnosticsPluginServiceApi
* @version 0.0.0.0
*/
export default class DiagnosticsPluginServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript/DiagnosticsPluginServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript/DiagnosticsPluginServiceApi~getEncodingdiagnosticsDiagnosticoptionsCallback
     ...
     * @param {module:EmbyClient.JavaScript/DiagnosticsPluginServiceApi~getEncodingdiagnosticsDiagnosticoptionsCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:EmbyClient.JavaScript/DiagnosticsPluginServiceApi~postEncodingdiagnosticsDiagnosticoptionsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:EmbyClient.JavaScript/DiagnosticsPluginServiceApi~postEncodingdiagnosticsDiagnosticoptionsCallback} callback The callback function, accepting three arguments: error, data, response
     */
