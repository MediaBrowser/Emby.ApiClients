...
* @module EmbyClient.JavaScript/StudiosServiceApi
* @version 0.0.0.0
*/
export default class StudiosServiceApi {

    /**
    * Constructs a new StudiosServiceApi. 
    * @alias module:EmbyClient.JavaScript/StudiosServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript/StudiosServiceApi~getStudiosCallback
     ...
     * @param {module:EmbyClient.JavaScript/StudiosServiceApi~getStudiosCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the getStudiosByName operation.
     * @callback module:EmbyClient.JavaScript/StudiosServiceApi~getStudiosByNameCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript/StudiosServiceApi~getStudiosByNameCallback} callback The callback function, accepting three arguments: error, data, response
