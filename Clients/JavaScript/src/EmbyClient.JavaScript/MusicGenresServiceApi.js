...
export default class MusicGenresServiceApi {
    ...
    * @alias module:EmbyClient.JavaScript/MusicGenresServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript/MusicGenresServiceApi~getMusicgenresCallback
     ...
     * @param {module:EmbyClient.JavaScript/MusicGenresServiceApi~getMusicgenresCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    /**
     * Callback function to receive the result of the getMusicgenresByName operation.
     * @callback module:EmbyClient.JavaScript/MusicGenresServiceApi~getMusicgenresByNameCallback
     * @param {String} error Error message, if any.
     ...
     * Requires authentication as user
     * @param {Object} opts Optional parameters
     * @param {module:EmbyClient.JavaScript/MusicGenresServiceApi~getMusicgenresByNameCallback} callback The callback function, accepting three arguments: error, data, response
