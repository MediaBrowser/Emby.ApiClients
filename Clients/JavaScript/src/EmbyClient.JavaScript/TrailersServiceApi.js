...
export default class TrailersServiceApi {
    ...
    /**
    * Constructs a new TrailersServiceApi. 
    * @alias module:EmbyClient.JavaScript/TrailersServiceApi
    * @class
    ...
    */
     ...
     * @callback module:EmbyClient.JavaScript/TrailersServiceApi~getTrailersCallback
     ...
     * @param {module:EmbyClient.JavaScript/TrailersServiceApi~getTrailersCallback} callback The callback function, accepting three arguments: error, data, response
