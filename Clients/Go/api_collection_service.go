...
/*
CollectionServiceApiService Gets a list of missing items
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *CollectionServiceApiGetCollectionsByIdMissingOpts - Optional Parameters:
...
type CollectionServiceApiGetCollectionsByIdMissingOpts struct {
...
func (a *CollectionServiceApiService) GetCollectionsByIdMissing(ctx context.Context, id string, localVarOptionals *CollectionServiceApiGetCollectionsByIdMissingOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Collections/{Id}/Missing"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id
 * @param optional nil or *CollectionServiceApiGetCollectionsByIdProvideritemsOpts - Optional Parameters:
     * @param "ArtistType" (optional.String) -  Artist or AlbumArtist
     * @param "MaxOfficialRating" (optional.String) -  Optional filter by maximum official rating (PG, PG-13, TV-MA, etc).
     * @param "HasThemeSong" (optional.Bool) -  Optional filter by items with theme songs.
     * @param "HasThemeVideo" (optional.Bool) -  Optional filter by items with theme videos.
...
type CollectionServiceApiGetCollectionsByIdProvideritemsOpts struct {
    ArtistType optional.String
    MaxOfficialRating optional.String
    HasThemeSong optional.Bool
    HasThemeVideo optional.Bool
...
func (a *CollectionServiceApiService) GetCollectionsByIdProvideritems(ctx context.Context, id string, localVarOptionals *CollectionServiceApiGetCollectionsByIdProvideritemsOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Collections/{Id}/ProviderItems"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
