...
/*
ContentServiceApiService
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
@return []ContentSection
*/
func (a *ContentServiceApiService) GetUsersByUseridHomesections(ctx context.Context, userId string) ([]ContentSection, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/HomeSections"
 ...
 * @param sectionId
 * @param userId User Id
 * @param optional nil or *ContentServiceApiGetUsersByUseridSectionsBySectionidItemsOpts - Optional Parameters:
...
type ContentServiceApiGetUsersByUseridSectionsBySectionidItemsOpts struct {
...
func (a *ContentServiceApiService) GetUsersByUseridSectionsBySectionidItems(ctx context.Context, sectionId string, userId string, localVarOptionals *ContentServiceApiGetUsersByUseridSectionsBySectionidItemsOpts) (QueryResultBaseItemDto, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/Sections/{SectionId}/Items"
...
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body ContentSection: 
 * @param userId User Id

*/
func (a *ContentServiceApiService) PostUsersByUseridHomesections(ctx context.Context, body ContentSection, userId string) (*http.Response, error) {
	var (
...
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body DeleteHomeSections
 * @param userId User Id

*/
func (a *ContentServiceApiService) PostUsersByUseridHomesectionsDelete(ctx context.Context, body UserLibraryDeleteHomeSections, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/HomeSections/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
...
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body MoveHomeSections
 * @param userId User Id

*/
func (a *ContentServiceApiService) PostUsersByUseridHomesectionsMove(ctx context.Context, body UserLibraryMoveHomeSections, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/HomeSections/Move"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
