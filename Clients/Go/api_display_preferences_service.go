...
/*
DisplayPreferencesServiceApiService Gets user settings
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userId User Id
@return map[string]string
*/
func (a *DisplayPreferencesServiceApiService) GetUsersettingsByUserid(ctx context.Context, userId string) (map[string]string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UserSettings/{UserId}"
...
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body UserSettings: 
 * @param userId User Id

*/
func (a *DisplayPreferencesServiceApiService) PostUsersettingsByUserid(ctx context.Context, body []string, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *DisplayPreferencesServiceApiService) PostUsersettingsByUseridPartial(ctx context.Context, body Object, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/UserSettings/{UserId}/Partial"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
