...
/*
UserServiceApiService Clears recently searched
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id

*/
func (a *UserServiceApiService) DeleteUsersByIdRecentlysearched(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/RecentlySearched"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserServiceApiService Gets copy data options
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return LibraryFullUserCopyDataOptions
*/
func (a *UserServiceApiService) GetUsersCopydataoptions(ctx context.Context) (LibraryFullUserCopyDataOptions, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LibraryFullUserCopyDataOptions
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/CopyDataOptions"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LibraryFullUserCopyDataOptions
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
*/
func (a *UserServiceApiService) PostUsersByIdRecentlysearchedDelete(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{Id}/RecentlySearched/Delete"
	localVarPath = strings.Replace(localVarPath, "{"+"Id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UserServiceApiService Copies data from one user to another
Requires authentication as administrator
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body CopyData
 * @param userId
...
*/
func (a *UserServiceApiService) PostUsersByUseridCopydata(ctx context.Context, body CopyData, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/CopyData"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
