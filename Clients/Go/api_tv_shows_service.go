...
func (a *TvShowsServiceApiService) GetShowsByIdSeasons(ctx context.Context, id string, localVarOptionals *TvShowsServiceApiGetShowsByIdSeasonsOpts) (QueryResultBaseItemDto, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
