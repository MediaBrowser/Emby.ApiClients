...
Requires authentication as user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body ReportItemsSearched
 * @param userId User Id

*/
func (a *UserLibraryServiceApiService) PostUsersByUseridSearcheditems(ctx context.Context, body UserLibraryReportItemsSearched, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/Users/{UserId}/SearchedItems/"
	localVarPath = strings.Replace(localVarPath, "{"+"UserId"+"}", fmt.Sprintf("%v", userId), -1)
