...
@return []LiveTvTunerHostInfo
*/
func (a *LiveTvServiceApiService) GetLivetvTunersDiscover(ctx context.Context) ([]LiveTvTunerHostInfo, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/LiveTv/Tuners/Discover"
...
@return LiveTvSeriesTimerInfoDto
*/
func (a *LiveTvServiceApiService) PostLivetvSeriestimers(ctx context.Context, body LiveTvSeriesTimerInfo) (LiveTvSeriesTimerInfoDto, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
