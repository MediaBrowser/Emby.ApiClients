...
public struct ServerConfiguration: Codable {
    ...
    public enum CodingKeys: String, CodingKey { 
        ...
        case maxOtherDbConnections = "Max_OtherDbConnections"
