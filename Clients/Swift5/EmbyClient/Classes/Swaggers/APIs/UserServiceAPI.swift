...
open class UserServiceAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func deleteUsersByIdRecentlysearched(_id: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        deleteUsersByIdRecentlysearchedWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    /**
     Clears recently searched
     - DELETE /Users/{Id}/RecentlySearched
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func deleteUsersByIdRecentlysearchedWithRequestBuilder(_id: String) -> RequestBuilder<Void> {
        var path = "/Users/{Id}/RecentlySearched"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{Id}", with: _idPostEscape, options: .literal, range: nil)
        let URLString = EmbyClientAPI.basePath + path
  ...
  "HasPassword" : true
    ...
    open class func getUsersByIdWithRequestBuilder(_id: String) -> RequestBuilder<UserDto> {
        ...
        let requestBuilder: RequestBuilder<UserDto>.Type = EmbyClientAPI.requestBuilderFactory.getBuilder()
  ...
  "Items" : [ {
    ...
    open class func getUsersItemaccessWithRequestBuilder(isHidden: Bool? = nil, isDisabled: Bool? = nil, startIndex: Int? = nil, limit: Int? = nil, nameStartsWithOrGreater: String? = nil, sortOrder: String? = nil) -> RequestBuilder<QueryResultUserDto> {
        ...
        let requestBuilder: RequestBuilder<QueryResultUserDto>.Type = EmbyClientAPI.requestBuilderFactory.getBuilder()
  ...
  "SessionInfo" : {
    ...
    open class func postUsersAuthenticatebynameWithRequestBuilder(body: AuthenticateUserByName, xEmbyAuthorization: String) -> RequestBuilder<AuthenticationAuthenticationResult> {
        ...
        let requestBuilder: RequestBuilder<AuthenticationAuthenticationResult>.Type = EmbyClientAPI.requestBuilderFactory.getBuilder()
  ...
  "SessionInfo" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postUsersByIdRecentlysearchedDelete(_id: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postUsersByIdRecentlysearchedDeleteWithRequestBuilder(_id: _id).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    /**
     Clears recently searched
     - POST /Users/{Id}/RecentlySearched/Delete
     ...
     - returns: RequestBuilder<Void> 
     */
    open class func postUsersByIdRecentlysearchedDeleteWithRequestBuilder(_id: String) -> RequestBuilder<Void> {
        var path = "/Users/{Id}/RecentlySearched/Delete"
        let _idPreEscape = "\(_id)"
        let _idPostEscape = _idPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{Id}", with: _idPostEscape, options: .literal, range: nil)
        let URLString = EmbyClientAPI.basePath + path
  ...
  "PinFile" : "PinFile"
    ...
    open class func postUsersForgotpasswordWithRequestBuilder(body: ForgotPassword) -> RequestBuilder<ForgotPasswordResult> {
        ...
        let requestBuilder: RequestBuilder<ForgotPasswordResult>.Type = EmbyClientAPI.requestBuilderFactory.getBuilder()
  ...
  "Success" : true
    ...
    open class func postUsersForgotpasswordPinWithRequestBuilder(body: ForgotPasswordPin) -> RequestBuilder<PinRedeemResult> {
        ...
        let requestBuilder: RequestBuilder<PinRedeemResult>.Type = EmbyClientAPI.requestBuilderFactory.getBuilder()
