...
open class FfmpegOptionsServiceAPI {
    /**
  ...
  "Object" : { }
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func postEncodingFfmpegoptions(body: Object, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postEncodingFfmpegoptionsWithRequestBuilder(body: body).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
     ...
     */
    open class func postEncodingFfmpegoptionsWithRequestBuilder(body: Object) -> RequestBuilder<Void> {
        let path = "/Encoding/FfmpegOptions"
        let URLString = SwaggerClientAPI.basePath + path
