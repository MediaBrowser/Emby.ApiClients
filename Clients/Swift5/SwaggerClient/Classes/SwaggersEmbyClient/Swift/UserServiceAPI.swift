...
open class UserServiceAPI {
  ...
  "Items" : [ {
    ...
    open class func getUsersQueryWithRequestBuilder(isHidden: Bool? = nil, isDisabled: Bool? = nil, startIndex: Int? = nil, limit: Int? = nil, nameStartsWithOrGreater: String? = nil) -> RequestBuilder<QueryResultUserDto> {
        ...
        let requestBuilder: RequestBuilder<QueryResultUserDto>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
  ...
  "SessionInfo" : {
    ...
    open class func postUsersAuthenticatebynameWithRequestBuilder(body: AuthenticateUserByName, xEmbyAuthorization: String) -> RequestBuilder<AuthenticationAuthenticationResult> {
        ...
        let requestBuilder: RequestBuilder<AuthenticationAuthenticationResult>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
  ...
  "PinFile" : "PinFile"
    ...
    open class func postUsersForgotpasswordWithRequestBuilder(body: ForgotPassword) -> RequestBuilder<UsersForgotPasswordResult> {
        ...
        let requestBuilder: RequestBuilder<UsersForgotPasswordResult>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
  ...
  "Success" : true
    ...
    open class func postUsersForgotpasswordPinWithRequestBuilder(body: ForgotPasswordPin) -> RequestBuilder<UsersPinRedeemResult> {
        ...
        let requestBuilder: RequestBuilder<UsersPinRedeemResult>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
