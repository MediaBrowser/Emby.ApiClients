...
/**
 * API tests for TvShowsServiceApi
 */
@Ignore
public class TvShowsServiceApiTest {

    private final TvShowsServiceApi api = new TvShowsServiceApi();
     ...
     */
    @Test
    public void getShowsByIdEpisodesTest() throws Exception {
        String id = null;
        Integer season = null;
     ...
     */
    @Test
    public void getShowsByIdSeasonsTest() throws Exception {
        String userId = null;
        String id = null;
        String fields = null;
        ...
        String enableImageTypes = null;
        Boolean enableUserData = null;
        QueryResultBaseItemDto response = api.getShowsByIdSeasons(userId, id, fields, isSpecialSeason, isMissing, adjacentTo, enableImages, imageTypeLimit, enableImageTypes, enableUserData);
     ...
     */
    @Test
    public void getShowsNextupTest() throws Exception {
        String userId = null;
        Integer startIndex = null;
        Integer limit = null;
        String fields = null;
        ...
        String enableImageTypes = null;
        Boolean enableUserData = null;
        QueryResultBaseItemDto response = api.getShowsNextup(userId, startIndex, limit, fields, seriesId, parentId, enableImages, imageTypeLimit, enableImageTypes, enableUserData);
     ...
     */
    @Test
    public void getShowsUpcomingTest() throws Exception {
        String userId = null;
        Integer startIndex = null;
        Integer limit = null;
        String fields = null;
        ...
        String enableImageTypes = null;
        Boolean enableUserData = null;
        QueryResultBaseItemDto response = api.getShowsUpcoming(userId, startIndex, limit, fields, parentId, enableImages, imageTypeLimit, enableImageTypes, enableUserData);
