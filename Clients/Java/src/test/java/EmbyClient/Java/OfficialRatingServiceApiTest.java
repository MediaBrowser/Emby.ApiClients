...
/**
 * API tests for OfficialRatingServiceApi
 */
@Ignore
public class OfficialRatingServiceApiTest {

    private final OfficialRatingServiceApi api = new OfficialRatingServiceApi();
     ...
     */
    @Test
    public void getOfficialratingsTest() throws Exception {
