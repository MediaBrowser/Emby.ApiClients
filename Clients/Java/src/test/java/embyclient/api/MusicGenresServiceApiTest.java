...
/**
 * API tests for MusicGenresServiceApi
 */
@Ignore
public class MusicGenresServiceApiTest {

    private final MusicGenresServiceApi api = new MusicGenresServiceApi();
     ...
     */
    @Test
    public void getMusicgenresTest() throws Exception {
     ...
     */
    @Test
    public void getMusicgenresByNameTest() throws Exception {
        String name = null;
        String userId = null;
        BaseItemDto response = api.getMusicgenresByName(name, userId);
