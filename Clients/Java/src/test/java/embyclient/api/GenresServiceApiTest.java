...
/**
 * API tests for GenresServiceApi
 */
@Ignore
public class GenresServiceApiTest {

    private final GenresServiceApi api = new GenresServiceApi();
     ...
     */
    @Test
    public void getGenresByNameTest() throws Exception {
        String name = null;
        String userId = null;
        BaseItemDto response = api.getGenresByName(name, userId);
