...
/**
 * API tests for PersonsServiceApi
 */
@Ignore
public class PersonsServiceApiTest {

    private final PersonsServiceApi api = new PersonsServiceApi();
     ...
     */
    @Test
    public void getPersonsByIdCreditsTest() throws Exception {
        String id = null;
        List<UserLibraryCreditsList> response = api.getPersonsByIdCredits(id);
    ...
    public void getPersonsByNameTest() throws Exception {
        String name = null;
        String userId = null;
        BaseItemDto response = api.getPersonsByName(name, userId);
