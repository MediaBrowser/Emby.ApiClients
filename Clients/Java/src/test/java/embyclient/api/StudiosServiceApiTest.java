...
/**
 * API tests for StudiosServiceApi
 */
@Ignore
public class StudiosServiceApiTest {

    private final StudiosServiceApi api = new StudiosServiceApi();
    ...
    public void getStudiosByNameTest() throws Exception {
        String name = null;
        String userId = null;
        BaseItemDto response = api.getStudiosByName(name, userId);
