...
/**
 * API tests for ContentServiceApi
 */
@Ignore
public class ContentServiceApiTest {

    private final ContentServiceApi api = new ContentServiceApi();
     ...
     */
    @Test
    public void getUsersByUseridHomesectionsTest() throws Exception {
        String userId = null;
        List<ContentSection> response = api.getUsersByUseridHomesections(userId);
     ...
     */
    @Test
    public void getUsersByUseridSectionsBySectionidItemsTest() throws Exception {
