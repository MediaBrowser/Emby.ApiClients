...
/**
 * API tests for GameGenresServiceApi
 */
@Ignore
public class GameGenresServiceApiTest {

    private final GameGenresServiceApi api = new GameGenresServiceApi();
     ...
     */
    @Test
    public void getGamegenresTest() throws Exception {
     ...
     */
    @Test
    public void getGamegenresByNameTest() throws Exception {
        String name = null;
        String userId = null;
        BaseItemDto response = api.getGamegenresByName(name, userId);
