...
import embyclient.model.ServerConfiguration;
...
public class ConfigurationServiceApi {
     ...
     */
    public com.squareup.okhttp.Call getSystemConfigurationCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getSystemConfigurationValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = getSystemConfigurationCall(progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Build call for getSystemConfigurationByKey
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getSystemConfigurationByKeyCall(String key, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getSystemConfigurationByKeyValidateBeforeCall(String key, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling getSystemConfigurationByKey(Async)");
        }
        
        com.squareup.okhttp.Call call = getSystemConfigurationByKeyCall(key, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void getSystemConfigurationByKey(String key) throws ApiException {
        getSystemConfigurationByKeyWithHttpInfo(key);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> getSystemConfigurationByKeyWithHttpInfo(String key) throws ApiException {
        com.squareup.okhttp.Call call = getSystemConfigurationByKeyValidateBeforeCall(key, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getSystemConfigurationByKeyAsync(String key, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getSystemConfigurationByKeyValidateBeforeCall(key, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for postSystemConfiguration
    ...
    private com.squareup.okhttp.Call postSystemConfigurationValidateBeforeCall(ServerConfiguration body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postSystemConfigurationCall(body, progressListener, progressRequestListener);
        return call;
    ...
    public com.squareup.okhttp.Call postSystemConfigurationAsync(ServerConfiguration body, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postSystemConfigurationValidateBeforeCall(body, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for postSystemConfigurationByKey
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postSystemConfigurationByKeyCall(Object body, String key, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postSystemConfigurationByKeyValidateBeforeCall(Object body, String key, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postSystemConfigurationByKey(Async)");
        }
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling postSystemConfigurationByKey(Async)");
        }
        
        com.squareup.okhttp.Call call = postSystemConfigurationByKeyCall(body, key, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postSystemConfigurationByKey(Object body, String key) throws ApiException {
        postSystemConfigurationByKeyWithHttpInfo(body, key);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postSystemConfigurationByKeyWithHttpInfo(Object body, String key) throws ApiException {
        com.squareup.okhttp.Call call = postSystemConfigurationByKeyValidateBeforeCall(body, key, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postSystemConfigurationByKeyAsync(Object body, String key, final ApiCallback<Void> callback) throws ApiException {
