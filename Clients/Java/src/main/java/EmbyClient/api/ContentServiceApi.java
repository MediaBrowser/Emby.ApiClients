...
public class ContentServiceApi {
    ...
    public ContentServiceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ContentServiceApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getUsersByUseridHomesections
     ...
     */
    public com.squareup.okhttp.Call getUsersByUseridHomesectionsCall(String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/Users/{UserId}/HomeSections"
    ...
    private com.squareup.okhttp.Call getUsersByUseridHomesectionsValidateBeforeCall(String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling getUsersByUseridHomesections(Async)");
        }
        
        com.squareup.okhttp.Call call = getUsersByUseridHomesectionsCall(userId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public List<ContentSection> getUsersByUseridHomesections(String userId) throws ApiException {
        ApiResponse<List<ContentSection>> resp = getUsersByUseridHomesectionsWithHttpInfo(userId);
        return resp.getData();
    }
     ...
     * Requires authentication as user
     * @param userId User Id (required)
     * @return ApiResponse&lt;List&lt;ContentSection&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ContentSection>> getUsersByUseridHomesectionsWithHttpInfo(String userId) throws ApiException {
        com.squareup.okhttp.Call call = getUsersByUseridHomesectionsValidateBeforeCall(userId, null, null);
        Type localVarReturnType = new TypeToken<List<ContentSection>>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getUsersByUseridHomesectionsAsync(String userId, final ApiCallback<List<ContentSection>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getUsersByUseridHomesectionsValidateBeforeCall(userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ContentSection>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getUsersByUseridSectionsBySectionidItems
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Item-Information.html"> Documentation</a>
     */
    public ApiResponse<QueryResultBaseItemDto> getUsersByUseridSectionsBySectionidItemsWithHttpInfo(String sectionId, String userId, String artistType, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, Boolean isSpecialSeason, String adjacentTo, String startItemId, Integer minIndexNumber, OffsetDateTime minStartDate, OffsetDateTime maxStartDate, OffsetDateTime minEndDate, OffsetDateTime maxEndDate, Integer minPlayers, Integer maxPlayers, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHD, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, Integer airedDuringSeason, OffsetDateTime minPremiereDate, OffsetDateTime minDateLastSaved, OffsetDateTime minDateLastSavedForUser, OffsetDateTime maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, String excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, String parentId, String fields, String excludeItemTypes, String includeItemTypes, String anyProviderIdEquals, String filters, Boolean isFavorite, Boolean isMovie, Boolean isSeries, Boolean isFolder, Boolean isNews, Boolean isKids, Boolean isSports, Boolean isNew, Boolean isPremiere, Boolean isNewOrPremiere, Boolean isRepeat, Boolean projectToMedia, String mediaTypes, String imageTypes, String sortBy, Boolean isPlayed, String genres, String officialRatings, String tags, String excludeTags, String years, Boolean enableImages, Boolean enableUserData, Integer imageTypeLimit, String enableImageTypes, String person, String personIds, String personTypes, String studios, String studioIds, String artists, String artistIds, String albums, String ids, String videoTypes, String containers, String audioCodecs, String audioLayouts, String videoCodecs, String extendedVideoTypes, String subtitleCodecs, String path, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean groupItemsIntoCollections, Boolean is3D, String seriesStatus, String nameStartsWithOrGreater, String artistStartsWithOrGreater, String albumArtistStartsWithOrGreater, String nameStartsWith, String nameLessThan) throws ApiException {
        com.squareup.okhttp.Call call = getUsersByUseridSectionsBySectionidItemsValidateBeforeCall(sectionId, userId, artistType, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, isSpecialSeason, adjacentTo, startItemId, minIndexNumber, minStartDate, maxStartDate, minEndDate, maxEndDate, minPlayers, maxPlayers, parentIndexNumber, hasParentalRating, isHD, isUnaired, minCommunityRating, minCriticRating, airedDuringSeason, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, anyProviderIdEquals, filters, isFavorite, isMovie, isSeries, isFolder, isNews, isKids, isSports, isNew, isPremiere, isNewOrPremiere, isRepeat, projectToMedia, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, excludeTags, years, enableImages, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, studioIds, artists, artistIds, albums, ids, videoTypes, containers, audioCodecs, audioLayouts, videoCodecs, extendedVideoTypes, subtitleCodecs, path, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, groupItemsIntoCollections, is3D, seriesStatus, nameStartsWithOrGreater, artistStartsWithOrGreater, albumArtistStartsWithOrGreater, nameStartsWith, nameLessThan, null, null);
    ...
    /**
     * Build call for postUsersByUseridHomesections
     * @param body ContentSection:  (required)
     * @param userId User Id (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridHomesectionsCall(ContentSection body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postUsersByUseridHomesectionsValidateBeforeCall(ContentSection body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postUsersByUseridHomesections(Async)");
        }
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling postUsersByUseridHomesections(Async)");
        }
        
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsCall(body, userId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postUsersByUseridHomesections(ContentSection body, String userId) throws ApiException {
        postUsersByUseridHomesectionsWithHttpInfo(body, userId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postUsersByUseridHomesectionsWithHttpInfo(ContentSection body, String userId) throws ApiException {
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsValidateBeforeCall(body, userId, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridHomesectionsAsync(ContentSection body, String userId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsValidateBeforeCall(body, userId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for postUsersByUseridHomesectionsDelete
     * @param body DeleteHomeSections (required)
     * @param userId User Id (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridHomesectionsDeleteCall(UserLibraryDeleteHomeSections body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/Users/{UserId}/HomeSections/Delete"
            .replaceAll("\\{" + "UserId" + "\\}", apiClient.escapeString(userId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postUsersByUseridHomesectionsDeleteValidateBeforeCall(UserLibraryDeleteHomeSections body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postUsersByUseridHomesectionsDelete(Async)");
        }
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling postUsersByUseridHomesectionsDelete(Async)");
        }
        
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsDeleteCall(body, userId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postUsersByUseridHomesectionsDelete(UserLibraryDeleteHomeSections body, String userId) throws ApiException {
        postUsersByUseridHomesectionsDeleteWithHttpInfo(body, userId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postUsersByUseridHomesectionsDeleteWithHttpInfo(UserLibraryDeleteHomeSections body, String userId) throws ApiException {
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsDeleteValidateBeforeCall(body, userId, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridHomesectionsDeleteAsync(UserLibraryDeleteHomeSections body, String userId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsDeleteValidateBeforeCall(body, userId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for postUsersByUseridHomesectionsMove
     * @param body MoveHomeSections (required)
     * @param userId User Id (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridHomesectionsMoveCall(UserLibraryMoveHomeSections body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/Users/{UserId}/HomeSections/Move"
            .replaceAll("\\{" + "UserId" + "\\}", apiClient.escapeString(userId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postUsersByUseridHomesectionsMoveValidateBeforeCall(UserLibraryMoveHomeSections body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postUsersByUseridHomesectionsMove(Async)");
        }
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling postUsersByUseridHomesectionsMove(Async)");
        }
        
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsMoveCall(body, userId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postUsersByUseridHomesectionsMove(UserLibraryMoveHomeSections body, String userId) throws ApiException {
        postUsersByUseridHomesectionsMoveWithHttpInfo(body, userId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postUsersByUseridHomesectionsMoveWithHttpInfo(UserLibraryMoveHomeSections body, String userId) throws ApiException {
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsMoveValidateBeforeCall(body, userId, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridHomesectionsMoveAsync(UserLibraryMoveHomeSections body, String userId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postUsersByUseridHomesectionsMoveValidateBeforeCall(body, userId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
