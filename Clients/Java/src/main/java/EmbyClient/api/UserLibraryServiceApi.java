...
public class UserLibraryServiceApi {
    ...
    /**
     * Build call for postUsersByUseridSearcheditems
     * @param body ReportItemsSearched (required)
     * @param userId User Id (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridSearcheditemsCall(UserLibraryReportItemsSearched body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/Users/{UserId}/SearchedItems/"
            .replaceAll("\\{" + "UserId" + "\\}", apiClient.escapeString(userId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postUsersByUseridSearcheditemsValidateBeforeCall(UserLibraryReportItemsSearched body, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postUsersByUseridSearcheditems(Async)");
        }
        // verify the required parameter 'userId' is set
        if (userId == null) {
            throw new ApiException("Missing the required parameter 'userId' when calling postUsersByUseridSearcheditems(Async)");
        }
        
        com.squareup.okhttp.Call call = postUsersByUseridSearcheditemsCall(body, userId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postUsersByUseridSearcheditems(UserLibraryReportItemsSearched body, String userId) throws ApiException {
        postUsersByUseridSearcheditemsWithHttpInfo(body, userId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postUsersByUseridSearcheditemsWithHttpInfo(UserLibraryReportItemsSearched body, String userId) throws ApiException {
        com.squareup.okhttp.Call call = postUsersByUseridSearcheditemsValidateBeforeCall(body, userId, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postUsersByUseridSearcheditemsAsync(UserLibraryReportItemsSearched body, String userId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postUsersByUseridSearcheditemsValidateBeforeCall(body, userId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
