...
import embyclient.model.NetEndPointInfo;
import embyclient.model.PackageVersionInfo;
import embyclient.model.PublicSystemInfo;
import embyclient.model.QueryResultLogFile;
import embyclient.model.QueryResultString;
import embyclient.model.SystemInfo;
import embyclient.model.WakeOnLanInfo;
...
public class SystemServiceApi {
    ...
    /**
     * Build call for headSystemPing
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call headSystemPingCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call headSystemPingValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = headSystemPingCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void headSystemPing() throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> headSystemPingWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = headSystemPingValidateBeforeCall(null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call headSystemPingAsync(final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = headSystemPingValidateBeforeCall(progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
