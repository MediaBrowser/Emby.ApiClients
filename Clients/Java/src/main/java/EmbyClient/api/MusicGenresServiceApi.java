...
public class MusicGenresServiceApi {
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Items-by-Name.html">Gets all music genres from a given item, folder, or the entire library Documentation</a>
     */
     ...
     * @throws ApiException If fail to serialize the request body object
     * API Documentation: Items by name
     * @see <a href="https://dev.emby.media/doc/restapi/Items-by-Name.html">Gets a music genre, by name Documentation</a>
     */
