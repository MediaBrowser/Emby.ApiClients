...
import embyclient.model.UserLibraryCreditsList;
...
public class PersonsServiceApi {
    private ApiClient apiClient;

    public PersonsServiceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PersonsServiceApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getPersonsByIdCredits
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getPersonsByIdCreditsCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/Persons/{Id}/Credits"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPersonsByIdCreditsValidateBeforeCall(String id, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getPersonsByIdCredits(Async)");
        }
        
        com.squareup.okhttp.Call call = getPersonsByIdCreditsCall(id, progressListener, progressRequestListener);
        return call;
     ...
     * Requires authentication as user
     * @param id The person id (required)
     * @return List&lt;UserLibraryCreditsList&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<UserLibraryCreditsList> getPersonsByIdCredits(String id) throws ApiException {
        ApiResponse<List<UserLibraryCreditsList>> resp = getPersonsByIdCreditsWithHttpInfo(id);
        return resp.getData();
    }
     ...
     * Requires authentication as user
     * @param id The person id (required)
     * @return ApiResponse&lt;List&lt;UserLibraryCreditsList&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<UserLibraryCreditsList>> getPersonsByIdCreditsWithHttpInfo(String id) throws ApiException {
        com.squareup.okhttp.Call call = getPersonsByIdCreditsValidateBeforeCall(id, null, null);
        Type localVarReturnType = new TypeToken<List<UserLibraryCreditsList>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Gets credits for a person (asynchronously)
     * Requires authentication as user
     * @param id The person id (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPersonsByIdCreditsAsync(String id, final ApiCallback<List<UserLibraryCreditsList>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPersonsByIdCreditsValidateBeforeCall(id, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<UserLibraryCreditsList>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getPersonsByName
     * @param name The person name (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     * API Documentation: Items by name
     * @see <a href="https://dev.emby.media/doc/restapi/Items-by-Name.html">Gets a person, by name Documentation</a>
     */
    public com.squareup.okhttp.Call getPersonsByNameCall(String name, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getPersonsByNameValidateBeforeCall(String name, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling getPersonsByName(Async)");
        }
        
        com.squareup.okhttp.Call call = getPersonsByNameCall(name, userId, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Items-by-Name.html">Gets a person, by name Documentation</a>
     */
    public BaseItemDto getPersonsByName(String name, String userId) throws ApiException {
        ApiResponse<BaseItemDto> resp = getPersonsByNameWithHttpInfo(name, userId);
        return resp.getData();
    }
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Items-by-Name.html">Gets a person, by name Documentation</a>
     */
    public ApiResponse<BaseItemDto> getPersonsByNameWithHttpInfo(String name, String userId) throws ApiException {
        com.squareup.okhttp.Call call = getPersonsByNameValidateBeforeCall(name, userId, null, null);
        Type localVarReturnType = new TypeToken<BaseItemDto>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Gets a person, by name (asynchronously)
     * Requires authentication as user
     * @param name The person name (required)
     * @param userId Optional. Filter by user id, and attach user data (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://dev.emby.media/doc/restapi/Items-by-Name.html">Gets a person, by name Documentation</a>
     */
    public com.squareup.okhttp.Call getPersonsByNameAsync(String name, String userId, final ApiCallback<BaseItemDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPersonsByNameValidateBeforeCall(name, userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BaseItemDto>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
