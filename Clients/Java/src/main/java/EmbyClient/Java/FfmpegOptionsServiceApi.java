...
public class FfmpegOptionsServiceApi {
     ...
     */
    public EmbyWebGenericEditEditObjectContainer getEncodingFfmpegoptions() throws ApiException {
        ApiResponse<EmbyWebGenericEditEditObjectContainer> resp = getEncodingFfmpegoptionsWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<EmbyWebGenericEditEditObjectContainer> getEncodingFfmpegoptionsWithHttpInfo() throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getEncodingFfmpegoptionsAsync(final ApiCallback<EmbyWebGenericEditEditObjectContainer> callback) throws ApiException {
