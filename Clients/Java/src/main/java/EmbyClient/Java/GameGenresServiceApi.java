...
public class GameGenresServiceApi {
     ...
     * @see <a href="https://github.com/MediaBrowser/Emby/wiki/Items-by-name">Gets all Game genres from a given item, folder, or the entire library Documentation</a>
     */
     ...
     * @throws ApiException If fail to serialize the request body object
     * API Documentation: Items by name
     * @see <a href="https://github.com/MediaBrowser/Emby/wiki/Items-by-name">Gets a Game genre, by name Documentation</a>
     */
