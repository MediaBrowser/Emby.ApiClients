...
public class ApiClient {
    ...
    private String basePath = "http://emby.media/emby";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://emby.media/emby
