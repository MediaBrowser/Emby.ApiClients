...
public class MusicGenresServiceApi {
    ...
    public MusicGenresServiceApi(ApiClient apiClient) {
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets all music genres from a given item, folder, or the entire library Documentation</a>
     */
    public ApiResponse<QueryResultBaseItemDto> getMusicgenresWithHttpInfo(String artistType, String maxOfficialRating, Boolean hasThemeSong, Boolean hasThemeVideo, Boolean hasSubtitles, Boolean hasSpecialFeature, Boolean hasTrailer, Boolean isSpecialSeason, String adjacentTo, String startItemId, Integer minIndexNumber, String minStartDate, String maxStartDate, String minEndDate, String maxEndDate, Integer minPlayers, Integer maxPlayers, Integer parentIndexNumber, Boolean hasParentalRating, Boolean isHD, Boolean isUnaired, Double minCommunityRating, Double minCriticRating, Integer airedDuringSeason, String minPremiereDate, String minDateLastSaved, String minDateLastSavedForUser, String maxPremiereDate, Boolean hasOverview, Boolean hasImdbId, Boolean hasTmdbId, Boolean hasTvdbId, String excludeItemIds, Integer startIndex, Integer limit, Boolean recursive, String searchTerm, String sortOrder, String parentId, String fields, String excludeItemTypes, String includeItemTypes, String anyProviderIdEquals, String filters, Boolean isFavorite, Boolean isMovie, Boolean isSeries, Boolean isFolder, Boolean isNews, Boolean isKids, Boolean isSports, Boolean isNew, Boolean isPremiere, Boolean isNewOrPremiere, Boolean isRepeat, Boolean projectToMedia, String mediaTypes, String imageTypes, String sortBy, Boolean isPlayed, String genres, String officialRatings, String tags, String excludeTags, String years, Boolean enableImages, Boolean enableUserData, Integer imageTypeLimit, String enableImageTypes, String person, String personIds, String personTypes, String studios, String studioIds, String artists, String artistIds, String albums, String ids, String videoTypes, String containers, String audioCodecs, String audioLayouts, String videoCodecs, String extendedVideoTypes, String subtitleCodecs, String path, String userId, String minOfficialRating, Boolean isLocked, Boolean isPlaceHolder, Boolean hasOfficialRating, Boolean groupItemsIntoCollections, Boolean is3D, String seriesStatus, String nameStartsWithOrGreater, String artistStartsWithOrGreater, String albumArtistStartsWithOrGreater, String nameStartsWith, String nameLessThan) throws ApiException {
        com.squareup.okhttp.Call call = getMusicgenresValidateBeforeCall(artistType, maxOfficialRating, hasThemeSong, hasThemeVideo, hasSubtitles, hasSpecialFeature, hasTrailer, isSpecialSeason, adjacentTo, startItemId, minIndexNumber, minStartDate, maxStartDate, minEndDate, maxEndDate, minPlayers, maxPlayers, parentIndexNumber, hasParentalRating, isHD, isUnaired, minCommunityRating, minCriticRating, airedDuringSeason, minPremiereDate, minDateLastSaved, minDateLastSavedForUser, maxPremiereDate, hasOverview, hasImdbId, hasTmdbId, hasTvdbId, excludeItemIds, startIndex, limit, recursive, searchTerm, sortOrder, parentId, fields, excludeItemTypes, includeItemTypes, anyProviderIdEquals, filters, isFavorite, isMovie, isSeries, isFolder, isNews, isKids, isSports, isNew, isPremiere, isNewOrPremiere, isRepeat, projectToMedia, mediaTypes, imageTypes, sortBy, isPlayed, genres, officialRatings, tags, excludeTags, years, enableImages, enableUserData, imageTypeLimit, enableImageTypes, person, personIds, personTypes, studios, studioIds, artists, artistIds, albums, ids, videoTypes, containers, audioCodecs, audioLayouts, videoCodecs, extendedVideoTypes, subtitleCodecs, path, userId, minOfficialRating, isLocked, isPlaceHolder, hasOfficialRating, groupItemsIntoCollections, is3D, seriesStatus, nameStartsWithOrGreater, artistStartsWithOrGreater, albumArtistStartsWithOrGreater, nameStartsWith, nameLessThan, null, null);
    ...
    /**
     * Build call for getMusicgenresByName
     ...
     * @throws ApiException If fail to serialize the request body object
     * API Documentation: Items by name
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a music genre, by name Documentation</a>
     */
    public com.squareup.okhttp.Call getMusicgenresByNameCall(String name, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/MusicGenres/{Name}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getMusicgenresByNameValidateBeforeCall(String name, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling getMusicgenresByName(Async)");
        }
        
        com.squareup.okhttp.Call call = getMusicgenresByNameCall(name, userId, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a music genre, by name Documentation</a>
     */
    public BaseItemDto getMusicgenresByName(String name, String userId) throws ApiException {
        ApiResponse<BaseItemDto> resp = getMusicgenresByNameWithHttpInfo(name, userId);
        return resp.getData();
    }
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a music genre, by name Documentation</a>
     */
    public ApiResponse<BaseItemDto> getMusicgenresByNameWithHttpInfo(String name, String userId) throws ApiException {
        com.squareup.okhttp.Call call = getMusicgenresByNameValidateBeforeCall(name, userId, null, null);
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a music genre, by name Documentation</a>
     */
    public com.squareup.okhttp.Call getMusicgenresByNameAsync(String name, String userId, final ApiCallback<BaseItemDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getMusicgenresByNameValidateBeforeCall(name, userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BaseItemDto>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
