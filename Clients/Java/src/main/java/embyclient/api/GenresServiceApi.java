...
public class GenresServiceApi {
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets all genres from a given item, folder, or the entire library Documentation</a>
     */
     ...
     * @throws ApiException If fail to serialize the request body object
     * API Documentation: Items by name
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a genre, by name Documentation</a>
     */
