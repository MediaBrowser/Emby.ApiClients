...
public class GameGenresServiceApi {
    ...
    /**
     * Build call for getGamegenresByName
     ...
     * @throws ApiException If fail to serialize the request body object
     * API Documentation: Items by name
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a Game genre, by name Documentation</a>
     */
    public com.squareup.okhttp.Call getGamegenresByNameCall(String name, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/GameGenres/{Name}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getGamegenresByNameValidateBeforeCall(String name, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling getGamegenresByName(Async)");
        }
        
        com.squareup.okhttp.Call call = getGamegenresByNameCall(name, userId, progressListener, progressRequestListener);
        return call;
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a Game genre, by name Documentation</a>
     */
    public BaseItemDto getGamegenresByName(String name, String userId) throws ApiException {
        ApiResponse<BaseItemDto> resp = getGamegenresByNameWithHttpInfo(name, userId);
        return resp.getData();
    }
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a Game genre, by name Documentation</a>
     */
    public ApiResponse<BaseItemDto> getGamegenresByNameWithHttpInfo(String name, String userId) throws ApiException {
        com.squareup.okhttp.Call call = getGamegenresByNameValidateBeforeCall(name, userId, null, null);
        Type localVarReturnType = new TypeToken<BaseItemDto>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Gets a Game genre, by name (asynchronously)
     * Requires authentication as user
     * @param name The genre name (required)
     * @param userId Optional. Filter by user id, and attach user data (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a Game genre, by name Documentation</a>
     */
    public com.squareup.okhttp.Call getGamegenresByNameAsync(String name, String userId, final ApiCallback<BaseItemDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGamegenresByNameValidateBeforeCall(name, userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BaseItemDto>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
