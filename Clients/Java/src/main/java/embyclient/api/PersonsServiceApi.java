...
public class PersonsServiceApi {
     ...
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets all persons from a given item, folder, or the entire library Documentation</a>
     */
     ...
     * @throws ApiException If fail to serialize the request body object
     * API Documentation: Items by name
     * @see <a href="https://betadev.emby.media/doc/restapi/Items-by-Name.html">Gets a person, by name Documentation</a>
     */
