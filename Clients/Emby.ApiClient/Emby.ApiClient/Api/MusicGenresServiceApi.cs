// <copyright file="MusicGenresServiceApi.cs" company="Emby LLC">
...
namespace Emby.ApiClient.Api
{
    ...
    /// </summary>
    public partial class MusicGenresServiceApi : IApiAccessor
    {
        /// <summary>
        ...
        public async Task<RestResponse<BaseItemDto>> GetMusicgenresByName (string name, string userId)
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new ApiException("Missing required parameter 'name' when calling MusicGenresServiceApi->GetMusicgenresByName");
            }
            
            var request = new RestRequest("/MusicGenres/{Name}", Method.Get);
