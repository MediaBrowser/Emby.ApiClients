// <copyright file="PersonsServiceApi.cs" company="Emby LLC">
...
namespace Emby.ApiClient.Api
{
    ...
    /// </summary>
    public partial class PersonsServiceApi : IApiAccessor
    {
        /// <summary>
        ...
        public async Task<RestResponse<BaseItemDto>> GetPersonsByName (string name, string userId)
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new ApiException("Missing required parameter 'name' when calling PersonsServiceApi->GetPersonsByName");
            }
            
            var request = new RestRequest("/Persons/{Name}", Method.Get);
