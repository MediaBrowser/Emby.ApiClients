// <copyright file="GenresServiceApi.cs" company="Emby LLC">
...
namespace Emby.ApiClient.Api
{
    ...
    /// </summary>
    public partial class GenresServiceApi : IApiAccessor
    {
        /// <summary>
        ...
        public async Task<RestResponse<BaseItemDto>> GetGenresByName (string name, string userId)
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
                throw new ApiException("Missing required parameter 'name' when calling GenresServiceApi->GetGenresByName");
            }
            
            var request = new RestRequest("/Genres/{Name}", Method.Get);
